[![CI](https://github.com/gap-packages/rcwa/actions/workflows/CI.yml/badge.svg)](https://github.com/gap-packages/rcwa/actions/workflows/CI.yml)
...
Author and Maintainer:  Stefan Kohl, https://stefan-kohl.github.io/
